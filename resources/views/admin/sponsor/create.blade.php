...
<div class="col-12">
    ...
    <form class="col-12 mx-auto" action="{{route('sponsor.store')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="form-row">
            <div class="form-group col-12 col-md-6 col-lg-3">
                <h4><label for="">Nombre</label></h4>
                <input name="name" class="form-control" type="text" value="{{ old('name') }}" required>
                <small id="passwordHelpBlock" class="form-text text-muted"><b>Nombre de la publicidad</b></small>
                @error('name')
            ...
            <div class="form-group col-12 col-md-6 col-lg-3">
                ...
                <input name="street" class="form-control" type="text" value="{{ old('street') }}" required>
                <small id="passwordHelpBlock" class="form-text text-muted"><b>Calle del negocio</b></small>
                <input name="number" class="form-control" type="number" value="#{{ old('number') }}">
                <small id="passwordHelpBlock" class="form-text text-muted"><b>Altura</b></small>
                @error('street')
                <div id="error" class="alert alert-danger mx-auto col-11 col-sm-4 col-lg-12"><span>{{ $message }}</span></div>
                @enderror
                @error('number')
            ...
            <div class="form-group col-12 col-md-6 col-lg-4">
                ...
                <input name="facebook-link" class="form-control" type="text">
            ...
            <div class="form-group col-12 col-md-6 col-lg-4">
                ...
                <input name="instagram-link" class="form-control" type="text">
            ...
            <div class="form-group col-12 col-md-6 col-lg-4">
                ...
                <textarea name="description" class="form-control" id="" cols="15" rows="5" required></textarea>
            </div>
        </div>
